                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img">
                                            <img src="admin/codes/<?php echo $image ?: $dummyImage; ?>" alt="<?php echo htmlspecialchars($tour['title']); ?>">
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                ...
                <div class="col-lg-5">
                    <div class="resort-content">
                        ...
                        <div class="resort-list">
                            ...
                            <a href="contact-us.php?url=<?php echo urlencode($tour['url']); ?>" class="th-btn style4 th-icon">Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="resort-grid-list">
                        ...
                        <li>
                            <div class="resort-grid-list-icon">
                                <img src="assets/img/icon/resort-icon1-<?php echo ($index % 10) + 1; ?>.svg" alt="img">
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="tours.php" class="th-btn">Browse All Tours</a>
                </div>
            </div>
        </div>
    </section>
